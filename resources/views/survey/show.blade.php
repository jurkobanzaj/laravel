                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input name="survey[name]" type="text" class="form-control" id="name" aria-describedby="nameeHelp" placeholder="Enter Name">
                        ...
                        <div>
                            <button class="btn btn-dark" type="submit">Complere Survey</button>
                        </div>
                    </div>
                </div>
            </form>
